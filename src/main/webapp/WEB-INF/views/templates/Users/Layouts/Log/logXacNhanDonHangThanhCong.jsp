...
<html>
<head>
    <title>Đơn hàng sang đóng gói</title>
...
<script>
    Swal.fire({
        ...
        icon: 'success',
        title: '<span style="font-size: 24px;">Xác nhận đơn hàng thành công!</span>',
        ...
        window.location.href = '/Admin/HoaDon/XacNhanHoaDonDangDongGoi';
