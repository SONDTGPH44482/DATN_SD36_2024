...
<html>
<head>
    <title>Xóa đơn hàng bị hủy thành công!</title>
...
<script>
    Swal.fire({
        ...
        icon: 'success',
        title: '<span style="font-size: 24px;">Xóa đơn hàng bị hủy thành công!</span>',
        showConfirmButton: false, // Ẩn nút OK
        timer: 1500, // Thời gian hiển thị thông báo (miligiây)

    }).then(() => {

        window.location.href = '/Admin/HoaDon/DonHangBiHuy';
