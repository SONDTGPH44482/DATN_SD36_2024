...
<html>
<head>
    <title>Thay đổi thông tin khách hàng thành công</title>
...
<script>
    Swal.fire({
        ...
        icon: 'success',
        title: '<span style="font-size: 24px;">Thay đổi thông tin thành công !</span>',
        showConfirmButton: false, // Ẩn nút OK
        timer: 1500, // Thời gian hiển thị thông báo (miligiây)

    }).then(() => {

        window.location.href = '/TrangChu/ThongTinCaNhan';
